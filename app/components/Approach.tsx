...
import { CanvasRevealEffect } from "./ui/CanvasRev";
  ...
  return (
    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center  gap-4 mx-auto px-8">
        ...
        description="we will collaborate to map out your website's goals"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development And Project Update" icon={<AceternityIcon order="phase 2" />}
        description="we will collaborate to map out your website's goals">
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute top-[5%] left-[5%] bottom-[5%]  transalate-x-[-20%] transalate-y-[-20%] group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
